...
(function() {
  var Tag, async, gumbo, outcome, tagsToObject, toarray, waitForCollectionSync, _;
  ...
  module.exports = (function() {
    ...
    */
    ...
    _Class.prototype.remove = function(tags, callback, reload) {
      ...
      return this.find(tags, o.s(function(tags) {
        return async.forEachSeries(tags, (function(tag, next) {
          return tag.destroy(next);
        }), function() {
          if (reload === false) {
            return callback;
          }
    ...
    */
    ...
    _Class.prototype.update = function(tags, callback) {
      return this.create(tags, callback, true);
    };
    ...
    */
    ...
    _Class.prototype._remove = function(tags, callback, reload) {
    ...
    */
    ...
    _Class.prototype._call = function(tags, command, reload, callback) {
      ...
      load = function(callback) {
        return _this._ec2.call(command, JSON.parse(JSON.stringify(data)), outcome.e(callback).s(function(result) {
          if (!reload) {
            return callback();
          }
          return _this._reload(callback);
    ...
    */
    ...
    _Class.prototype._fixTags = function(tags) {
      tags = toarray(tags);
