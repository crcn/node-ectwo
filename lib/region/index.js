...
(function() {
  var Images, Instances, KeyPairs, async, cstep, gumbo,
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    function _Class(collection, options) {
      ...
      this._loadables = [this.images = new Images(this), this.instances = new Instances(this), this.keyPairs = new KeyPairs(this)];
    }
