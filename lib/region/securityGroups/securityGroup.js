...
(function() {
  ...
  SecurityGroup = (function(_super) {
    ...
    */
    ...
    SecurityGroup.prototype.authorize = function(optionsOrPort, next) {
      return this._runCommand("AuthorizeSecurityGroupIngress", optionsOrPort, next);
    };
    ...
    */
    ...
    SecurityGroup.prototype.revoke = function(optionsOrPort, next) {
      return this._runCommand("RevokeSecurityGroupIngress", optionsOrPort, next);
    };
    ...
    */
    ...
    SecurityGroup.prototype._runCommand = function(command, optionsOrPort, next) {
      ...
      return this.api.call(command, query, outcome.e(next).s(function(result) {
