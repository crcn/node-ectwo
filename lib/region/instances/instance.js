...
(function() {
  var BaseModel, Tags, comerr, createInstance, gumbo, objectToTags, outcome, stepc, tagsToObject, _,
  ...
  */
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype.syncImageTags = function(callback) {};
      ...
      return this.stop(function() {
        return _this._ec2.call("CreateImage", {
          ...
          return _this.region.images.syncAndFindOne({
            ...
            var tags;
            tags = tagsToObject(_this.get("tags") || []);
            tags.createdAt = Date.now();
            return image.tags.create(objectToTags(tags), o.s(function() {
