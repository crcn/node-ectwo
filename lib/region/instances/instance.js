...
(function() {
  var comerr, createImage, gumbo, outcome, stepc, _,
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype.start2 = function(callback) {
      var state,
        _this = this;
      state = this.get("instanceState.name");
    ...
    */
    ...
    _Class.prototype.createImage = function(options, callback) {
      ...
      return stepc.async(function() {
        return _this._ec2.call("CreateImage", {
          "InstanceId": _this.get("instanceId"),
    ...
    */
    ...
    _Class.prototype.clone = function(callback) {
      ...
      o = outcome.e(callback);
      self = this;
      return createImage(this.region, {
        imageId: this.get("imageId"),
        flavor: this.get("instanceType")
      }, callback);
    };
    ...
    */
    ...
    _Class.prototype._skipIfState = function(state, end, next) {
      ...
      return stepc.async(function() {
        ...
        if (stateTest.test(_this.get("instanceState.name"))) {
          return end();
        } else {
          return next();
        }
    ...
    */
    ...
    _Class.prototype._runCommand = function(expectedState, runCommand, onComplete) {
      ...
      return this._skipIfState(expectedState, callback, function() {
        state(_this.get("instanceState.name"));
        ...
        if (!/stopping|stopped|shutting-down|running|pending/.test(state)) {
          return onComplete(new comerr.UnknownError("An unrecognized instance state was returned."));
        } else {
          return runCommand();
        }
      });
