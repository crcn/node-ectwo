...
(function() {
  var Instance, bindable, comerr, outcome, toarray, type, utils, _,
  ...
  */
  ...
  Instance = (function(_super) {
    ...
    */
    ...
    Instance.prototype.update = function(options, next) {
      var o, ops, state, _ref,
        _this = this;

      ops = utils.cleanObj({
        "InstanceId": this.get("_id"),
        "InstanceType.Value": (_ref = options.type) != null ? _ref : options.flavor,
      ...
      return this.stop(function() {
        return _this.api.call("ModifyInstanceAttribute", ops, o.s(function() {
          return _this.reload(o.s(function() {
            if (state !== "running") {
    ...
    */
    ...
    Instance.prototype.volumes = function(next) {
      return this.region.volumes.find({
        "attachments.instanceId": this.get("_id")
      }, next);
    };
    ...
    */
    ...
    Instance.prototype.resize = function(type, next) {
      return this.update({
        type: type
      }, next);
    };
    ...
    */
    ...
    Instance.prototype.status = function(next) {
      var _this = this;

      return this.api.call("DescribeInstanceStatus", {
        "InstanceId.0": this.get("_id")
      }, outcome.e(next).s(function(result) {
        var statuses;

        statuses = toarray(result.instanceStatusSet.item).map(function(status) {
          var obj;

          obj = new bindable.Object(status);
          obj.toString = function() {
            return _this.toString() + ".status";
          };
          return obj;
        });
        return next(null, statuses);
      }));
    };
    ...
    */
    ...
    Instance.prototype.createImage = function(options, next) {
      ...
      return this.api.call("CreateImage", options, o.s(function(result) {
        return _this.region.images.waitForOne({
          _id: result.imageId
        }, o.s(function(image) {
          return image.tag(_this.get("tags"), function() {
