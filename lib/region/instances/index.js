...
(function() {
  var BaseCollection, InstanceModel, comerr, findTags, flatten, gumbo, outcome, sift, stepc, toarray, _,
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype._load = function(options, onLoad) {
      ...
      return self.ec2.call("DescribeInstances", search, outcome.e(onLoad).s(function(result) {
        ...
        instances = flatten(instances.map(function(instance) {
          ...
          return {
            ...
            tags: toarray(instance.tagSet).map(function(tag) {
              return tag.item;
            })
          };
