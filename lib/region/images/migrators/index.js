    ...
    */
    ...
    _Class.prototype._watchMigrator = function(migrator, i) {
      ...
      migrator.on("progress", function(progress) {
        ...
        _this._totalProgress = Math.round(sum / _this._progresses.length);
        return _this.emit("progress", _this._totalProgress);
      });
      return migrator.on("complete", function(image) {
        _this._images.push(image);
        console.log(_this._images.length, _this._progresses.length);
