...
(function() {
  var BaseModel, Migrator, Migrators, Tags, allRegions, async, createInstance, gumbo, outcome, stepc, tagsToObject, toarray,
    ...
    _Class.prototype.migrate = function(regions, callback) {
      ...
      return this.getSnapshot(o.s(function(snapshot) {
        return async.map(toarray(regions), (function(region, next) {
          ...
          return callback(null, new Migrators(migrators));
        }));
      }));
    };
