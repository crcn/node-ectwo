...
(function() {
  var BaseModel, Tags, allRegions, createInstance, gumbo, outcome, stepc, tagsToObject, toarray,
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype.getSnapshot = function(callback) {
      return this.region.snapshots.findOne({
        ...
        return async.forEach(toarray(regions), (function(region, next) {
          return region.snapshots.copy({
            ...
            "description": JSON.stringify({
              "image": {
                "architecture": _this.get("architecture"),
                "kernelId": _this.get("kernelId"),
