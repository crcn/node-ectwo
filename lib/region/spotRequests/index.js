...
(function() {
  var BaseCollection, Pricing, SpotRequest, async, outcome, toarray,
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype.create = function(options, callback) {
      ...
      return this.ec2.call("RequestSpotInstances", realOps, outcome.e(callback).s(function(result) {
    ...
    */
    ...
    _Class.prototype._load = function(options, onLoad) {
      ...
      return this.ec2.call("DescribeSpotInstanceRequests", search, outcome.e(onLoad).s(function(result) {
        var requests;
