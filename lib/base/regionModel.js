...
(function() {
  ...
  BaseRegionModel = (function(_super) {
    ...
    */
    ...
    BaseRegionModel.prototype.toString = function() {
      return this.region.get("_id") + "." + this.get("_id");
    };
    ...
    */
    ...
    BaseRegionModel.prototype.tag = function(nameOrTags, value, next) {
      var called, createTags, deleteTags, i, name, tag, tags, tryTagging,
        _this = this;
      ...
      return this._modifyTags("DeleteTags", deleteTags, function() {
