...
(function() {
  var BaseCollection, bindable, comerr, hurryup, memoize, outcome, sift, type,
  ...
  BaseCollection = (function(_super) {
    ...
    */
    ...
    BaseCollection.prototype.all = function(cb) {
      return this.find(cb);
    };
    ...
    */
    ...
    BaseCollection.prototype.find = function(query, next) {
      ...
      return this.load({}, outcome.e(next).s(function(results) {
        var sifter;
